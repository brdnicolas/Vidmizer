...
OPEN_INFO = {
    ...
    # JPEG compressed videos handled by LibTiff and auto-converted to RGBX
    # Minimal Baseline TIFF requires YCbCr videos to have 3 SamplesPerPixel
...
class TiffImageFile(ImageFile.ImageFile):
    ...
    def _seek(self, frame):
        ...
        while len(self._frame_pos) <= frame:
            if not self.__next:
                raise EOFError("no more videos in TIFF file")
            if DEBUG:
                print(
    ...
    def _setup(self):
        ...
        # old style jpeg compression videos most certainly are YCbCr
        ...
        if self.use_load_libtiff:
            ...
            # so large g4 videos will fail if we use that
            # function.
            #
...
def _save(im, fp, filename):
    ...
    # required for color libtiff videos
